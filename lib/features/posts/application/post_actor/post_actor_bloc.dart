  ...
  Stream<PostActorState> mapEventToState(
    ...
    yield* event.map(
      getData: (e) async* {
        ...
        final senderUser =
            await _postRepository.getUserProfile(e.post.senderID.getOrCrash());
        ...
        _repostStreamSubscription = _postRepository.watchReposts(e.post).listen(
            (reposts) =>
                add(PostActorEvent.repostsReceived(reposts, e.currentUserID)));
        ...
        _bookmarkStreamSubscription = _postRepository
            ...
            .listen((bookmarks) => add(
                PostActorEvent.bookmarksReceived(bookmarks, e.currentUserID)));
      ...
      toggleLikePost: (_Liked value) async* {
        ...
        _likeStreamSubscription = _postRepository.watchLikes(value.post).listen(
            (likes) =>
                add(PostActorEvent.likesReceived(likes, value.currentUserID)));
      },
      toggleRepostPost: (_Reposted value) async* {
        ...
        _repostStreamSubscription = _postRepository
            ...
            .listen((reposts) => add(
                PostActorEvent.repostsReceived(reposts, value.currentUserID)));
      },

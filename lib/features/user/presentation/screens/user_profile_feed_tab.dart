...
class UserProfileFeedTab extends StatefulWidget {
  final String userID;
  final String name;
  final User user;

  const UserProfileFeedTab({
    Key key,
    this.userID,
    this.name,
    this.user,
  ...
  @override
  _UserProfileFeedTabState createState() => _UserProfileFeedTabState();
}

class _UserProfileFeedTabState extends State<UserProfileFeedTab> {
  @override
  void initState() {
    super.initState();
  }
              ...
              child: RefreshIndicator(
                onRefresh: () async {
                  context
                      ...
                      .add(PostWatcherEvent.getData(widget.userID, false));
                },

...
class OrganizationPageEventTab extends StatefulWidget {
  final String name;
  final bool isAdmin;
  final Organization org;

  const OrganizationPageEventTab({
    Key key,
    this.name,
    this.isAdmin,
    this.org,
  }) : super(key: key);
  _OrganizationPageEventTabState createState() =>
      _OrganizationPageEventTabState();
}

class _OrganizationPageEventTabState extends State<OrganizationPageEventTab> {
                                  ...
                                  return BlocProvider<EventDetailBloc>(
                                      create: (context) => getIt<
                                        ...
                                        ..add(EventDetailEvent.getData(
                                            senderID:
                                                state.events[index].senderID,
                                            currentUserID: currentUserID,
                                            orgID: state.events[index].orgID,
                                            eventID: state.events[index].eventID
                                                .getOrCrash(),
                                            isOrg: state.events[index].isOrg)),

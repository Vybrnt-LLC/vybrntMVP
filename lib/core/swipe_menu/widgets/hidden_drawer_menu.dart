...
import 'package:vybrnt_mvp/core/swipe_menu/widgets/hidden_menu.dart';
import 'package:vybrnt_mvp/core/swipe_menu/widgets/item_hidden_menu.dart';
import 'package:vybrnt_mvp/core/swipe_menu/widgets/screen_hidden_drawer.dart';
import 'package:vybrnt_mvp/core/swipe_menu/widgets/simple_hidden_drawer.dart';
      ...
      screenSelectedBuilder: (position, bloc) {
        ...
        return ChangeNotifierProvider<TabColor>(
          ...
          child: Scaffold(
            ...
            //body: NavBarSetUp(bloc: bloc, userID: userID, currentUserID: currentUserID,),
          ),
        );
      },
    );

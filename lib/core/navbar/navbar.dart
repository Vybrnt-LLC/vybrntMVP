...
import 'package:vybrnt_mvp/core/navbar/curves.dart';
      ...
      child: Stack(
        children: [
          Positioned(
            ...
            width: appSize.width,
            height: height,
            child: _buildBackground(tabColor),
          ),
          Positioned(
            ...
            child: Row(
              ...
              children: _buildButtons(tabColor),
            ),
          ),
        ],
      ),
...
class _BackgroundCurvePainter extends CustomPainter {
  ...
  static const _topY = 2.0;
  static const _bottomY = 54.0;
  static const _topDistance = 1.0;
